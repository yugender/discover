...
**discover** is an android app that allows a user to search for articles on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
* [x] Card View for the articles with the headline text on the images

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/iIT72cw.gifv' title='Video Walkthrough' width='' alt='Video Walkthrough' />
